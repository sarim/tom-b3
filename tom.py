...
# tom.py
#
# TerroristOfTheMatch Plugin for BigBrotherBot(B3) (www.bigbrotherbot.net)
# Copyright (C) 2012 <Sarim Khan>
# 
...
#--------------------------------------------------------------------------------------------------
class TomPlugin(b3.plugin.Plugin):
    def onStartup(self):
        """\
        ...
        # Register commands
        self._adminPlugin.registerCommand(self, 'helloworld', 1, self.cmd_helloWorld, 'hello')
